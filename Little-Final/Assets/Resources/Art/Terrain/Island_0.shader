...
Shader "Island_0"
{
	Properties
	{
		...
		[NoScaleOffset]_Terrain_1001_Roughness("Terrain_1001_Roughness", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _Terrain_1001_Roughness;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Metallic = 0.0;
			float2 uv_Terrain_1001_Roughness5 = i.uv_texcoord;
			o.Smoothness = ( 1.0 - tex2D( _Terrain_1001_Roughness, uv_Terrain_1001_Roughness5 ) ).r;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17800
241;379;1055;717;1175.582;373.7859;1.776995;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;39;304.193,804.7906;Inherit;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=4AACE7520D317764B13C7421F131B5E51578CB5C