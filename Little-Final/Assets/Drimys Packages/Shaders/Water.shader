...
Shader "Drimys/Nature/Water"
{
	Properties
	{
		...
		_BigWavesScale("Big Waves Scale", Float) = 0.2
		_BigWavesSpeed("Big Waves Speed", Float) = 3
		_WavesLevelsMin("Waves Levels Min", Float) = 0.89
		_WavesLevelsMax("Waves Levels Max", Float) = 0.89
	...
	SubShader
	{
		...
		uniform float _BigWavesScale;
		uniform float _WavesLevelsMin;
		uniform float _WavesLevelsMax;
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 temp_output_192_0 = ( ( 1.0 - SpeedDirWaves158 ) * _WindSpeed );
			...
			float2 panner265 = ( 1.0 * _Time.y * ( temp_output_192_0 * _BigWavesSpeed ) + temp_output_24_0);
			float simplePerlin2D250 = snoise( panner265*_BigWavesScale );
			simplePerlin2D250 = simplePerlin2D250*0.5 + 0.5;
			float2 panner267 = ( 1.0 * _Time.y * ( ( SpeedDirWaves158 * 1.0 ) * _BigWavesSpeed ) + temp_output_24_0);
			float simplePerlin2D268 = snoise( panner267*_BigWavesScale );
			simplePerlin2D268 = simplePerlin2D268*0.5 + 0.5;
			float WavesPattern66 = ( simplePerlin2D9 + simplePerlin2D48 + (_WavesLevelsMin + (simplePerlin2D250 - 0.0) * (_WavesLevelsMax - _WavesLevelsMin) / (1.0 - 0.0)) + (_WavesLevelsMin + (simplePerlin2D268 - 0.0) * (_WavesLevelsMax - _WavesLevelsMin) / (1.0 - 0.0)) );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			simplePerlin2D268 = simplePerlin2D268*0.5 + 0.5;
			float WavesPattern66 = ( simplePerlin2D9 + simplePerlin2D48 + (_WavesLevelsMin + (simplePerlin2D250 - 0.0) * (_WavesLevelsMax - _WavesLevelsMin) / (1.0 - 0.0)) + (_WavesLevelsMin + (simplePerlin2D268 - 0.0) * (_WavesLevelsMax - _WavesLevelsMin) / (1.0 - 0.0)) );
			float height107_g5 = ( WavesPattern66 * _NormalFactor );
			float scale107_g5 = 1.0;
...
/*ASEBEGIN
Version=18900
1786;1235;1909;847;2378.729;-911.5773;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;184;-3008,-1024;Inherit;False;Property;_SpeedDirX;Speed Dir X;13;0;Create;True;0;0;0;False;0;False;0;0.8;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;185;-3008,-896;Inherit;False;Property;_SpeedDirY;Speed Dir Y;14;0;Create;True;0;0;0;False;0;False;0;0.8;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;183;-3024,-128;Inherit;False;Property;_WindSpeed;Wind Speed;15;0;Create;True;0;0;0;False;0;False;0;0.8;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;179;-3056,480;Inherit;False;Property;_WaveScaleX;Wave Scale  X;7;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;182;-3056,624;Inherit;False;Property;_WaveScaleY;Wave Scale Y;8;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;86;-2505.23,355.7284;Inherit;False;2722.08;1220.808;Waves patern;41;66;288;287;285;286;281;282;283;284;292;289;291;290;25;17;178;161;277;278;121;272;270;271;266;251;48;250;268;38;257;273;275;276;9;267;265;49;11;24;18;192;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;272;-2017,1166;Inherit;False;Property;_BigWavesSpeed;Big Waves Speed;10;0;Create;True;0;0;0;False;0;False;3;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;251;-1280,1134;Inherit;False;Property;_BigWavesScale;Big Waves Scale;9;0;Create;True;0;0;0;False;0;False;0.2;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-3168,-464;Inherit;False;Property;_FoamDistance;Foam Distance;20;0;Create;True;0;0;0;False;0;False;0;0.216;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;101;-2464,-208;Inherit;False;Property;_FoamScale;Foam Scale;21;0;Create;True;0;0;0;False;0;False;0;0.204;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;275;-768,1374;Inherit;False;Property;_WavesLevelsMin;Waves Levels Min;11;0;Create;True;0;0;0;False;0;False;0.89;0.46;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-2048,-1168;Inherit;False;Property;_DepthDistance;Depth Distance;18;0;Create;True;0;0;0;False;0;False;0;0.246;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;276;-768,1454;Inherit;False;Property;_WavesLevelsMax;Waves Levels Max;12;0;Create;True;0;0;0;False;0;False;0.89;-1.34;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-2288,-384;Inherit;False;Property;_FoamBorder;Foam Border;19;0;Create;True;0;0;0;False;0;False;0;0.465;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;113;-1300.53,-217.8876;Inherit;False;Property;_FoamRangeMax;Foam Range Max;25;0;Create;True;0;0;0;False;0;False;0;0.456;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;112;-1311.755,-324.339;Inherit;False;Property;_FoamRangeMin;Foam Range Min;24;0;Create;True;0;0;0;False;0;False;0;0.43;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;57;-1305.57,-1792;Inherit;False;Property;_WatherColor2;Wather Color 2;6;0;Create;True;0;0;0;False;0;False;0.510235,0.8939884,0.9245283,0;0.343761,0.4942933,0.7075471,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;56;-1289.57,-2000;Inherit;False;Property;_WatherColor1;Wather Color 1;5;0;Create;True;0;0;0;False;0;False;0.510235,0.8939884,0.9245283,0;0.3889283,0.6032161,0.8679245,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;63;-1369.57,-1376;Inherit;False;Property;_DepthColor;Depth Color;17;0;Create;True;0;0;0;False;0;False;0.990566,0.1170263,0,0;0.426193,0,0.8490566,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;72;-2240.957,-683.376;Inherit;False;Property;_FoamColor;Foam Color;22;0;Create;True;0;0;0;False;0;False;0.990566,0.1170263,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;88;1491.533,-108.5983;Inherit;False;Property;_OpacityBase;Opacity Base;27;0;Create;True;0;0;0;False;0;False;0;0.9;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;193;1255.542,138.5918;Inherit;False;Property;_VertexOffsetFactor;Vertex Offset Factor;16;0;Create;True;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;172;1293.603,-847.8861;Inherit;False;Property;_NormalFactor;Normal Factor;23;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;156;609,-166;Inherit;False;Property;_ReflectionSwich;Reflection Swich;28;0;Create;True;0;0;0;False;0;False;1;0.6;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;245;1315.701,395.3256;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;247;1660.701,398.3256;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;248;1406.701,626.3256;Inherit;False;16;WorldSpaceUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;139;-268.9955,-69.49028;Inherit;False;Property;_ScaleRefraction;Scale Refraction;29;0;Create;True;0;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;141;-545.7002,-186.7676;Inherit;False;66;WavesPattern;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;244;1064.701,352.3256;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;214;1301.146,-978.0356;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;246;1041.701,524.3257;Inherit;False;Constant;_Float0;Float 0;22;0;Create;True;0;0;0;False;0;False;0.3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;170;1495.052,-361.9894;Inherit;False;Property;_Smoothness;Smoothness;26;0;Create;True;0;0;0;False;0;False;1;0.98;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;168;1640.555,-969.8514;Inherit;True;Normal From Height;-1;;5;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;1;False;2;FLOAT3;40;FLOAT3;0
...
ASEEND*/
//CHKSM=62B1CD4673CBFA1F797E67CC00EC7A15E57B6EBE