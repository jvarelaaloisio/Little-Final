...
Shader "Lemu/Nature/Water"
{
	...
	SubShader
	{
		...
		float3 PerturbNormal107_g19( float3 surf_pos, float3 surf_norm, float height, float scale )
		{
		...
		float voronoi385( float2 v, float time, inout float2 id, inout float2 mr, float smoothness )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
		...
		float voronoi405( float2 v, float time, inout float2 id, inout float2 mr, float smoothness )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 surf_pos107_g19 = ase_worldPos;
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 surf_norm107_g19 = ase_worldNormal;
			float2 appendResult186 = (float2(( _Waves__SpeedFactor * _Waves__SpeedDirX ) , ( _Waves__SpeedDirY * _Waves__SpeedFactor )));
			float2 SpeedDirWaves158 = appendResult186;
			float2 appendResult15 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 WorldSpaceUV16 = appendResult15;
			...
			simplePerlin2D268 = simplePerlin2D268*0.5 + 0.5;
			float WavesPattern66 = ( simplePerlin2D9 + simplePerlin2D48 + (_BigWaves__LevelsMin + (simplePerlin2D250 - 0.0) * (_BigWaves__LevelsMax - _BigWaves__LevelsMin) / (1.0 - 0.0)) + (_BigWaves__LevelsMin + (simplePerlin2D268 - 0.0) * (_BigWaves__LevelsMax - _BigWaves__LevelsMin) / (1.0 - 0.0)) );
			float height107_g19 = ( WavesPattern66 * _Waves__NormalFactor );
			float scale107_g19 = 1.0;
			float3 localPerturbNormal107_g19 = PerturbNormal107_g19( surf_pos107_g19 , surf_norm107_g19 , height107_g19 , scale107_g19 );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentDir42_g19 = mul( ase_worldToTangent, localPerturbNormal107_g19);
			float3 NormalOutput300 = worldToTangentDir42_g19;
			...
			float2 id385 = 0;
			float2 uv385 = 0;
			float voroi385 = voronoi385( coords385, time385, id385, uv385, 0 );
			float mulTime404 = _Time.y * -_Water__PatternDetailSpeed;
			float time405 = mulTime404;
			float2 coords405 = i.uv_texcoord * ( _Water__PatternScale - -20.0 );
			float2 id405 = 0;
			float2 uv405 = 0;
			float voroi405 = voronoi405( coords405, time405, id405, uv405, 0 );
			...
			float4 temp_output_21_0_g20 = saturate( lerpResult79 );
			float4 color20_g20 = IsGammaSpace() ? float4(0.509434,0.509434,0.509434,0) : float4(0.2228772,0.2228772,0.2228772,0);
			float2 temp_cast_0 = (0.1).xx;
			float2 appendResult5_g20 = (float2(ase_worldPos.x , ase_worldPos.z));
			float temp_output_2_0_g20 = ( 0.01 * 1.5 );
			float2 panner10_g21 = ( 1.0 * _Time.y * temp_cast_0 + ( appendResult5_g20 * temp_output_2_0_g20 ));
			float simplePerlin2D11_g21 = snoise( panner10_g21 );
			simplePerlin2D11_g21 = simplePerlin2D11_g21*0.5 + 0.5;
			float temp_output_8_0_g20 = simplePerlin2D11_g21;
			float2 temp_cast_1 = (0.1).xx;
			float2 panner10_g23 = ( 1.0 * _Time.y * temp_cast_1 + ( appendResult5_g20 * 0.01 ));
			float simplePerlin2D11_g23 = snoise( panner10_g23 );
			simplePerlin2D11_g23 = simplePerlin2D11_g23*0.5 + 0.5;
			float2 temp_cast_2 = (0.1).xx;
			float2 panner10_g22 = ( 1.0 * _Time.y * temp_cast_2 + ( appendResult5_g20 * ( temp_output_2_0_g20 * 4.0 ) ));
			float simplePerlin2D11_g22 = snoise( panner10_g22 );
			simplePerlin2D11_g22 = simplePerlin2D11_g22*0.5 + 0.5;
			float3 _Vector2 = float3(0,-1.6,1);
			float temp_output_16_0_g20 = saturate( (_Vector2.y + (( ( ( temp_output_8_0_g20 * simplePerlin2D11_g23 ) + ( 1.0 - simplePerlin2D11_g22 ) ) * temp_output_8_0_g20 ) - 0.0) * (_Vector2.z - _Vector2.y) / (1.0 - 0.0)) );
			float4 lerpResult24_g20 = lerp( temp_output_21_0_g20 , saturate( ( temp_output_21_0_g20 * color20_g20 ) ) , ( temp_output_16_0_g20 * 1.0 ));
			float4 BaseColorOutput302 = lerpResult24_g20;
...
/*ASEBEGIN
Version=18900
17;1018;1921;1074;3256.646;-280.7426;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;184;-3536,-992;Inherit;False;Property;_Waves__SpeedDirX;Waves__Speed Dir X;9;0;Create;True;0;0;0;False;0;False;0;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;182;-3549.823,635.5737;Inherit;False;Property;_Waves__ScaleY;Waves__Scale Y;8;0;Create;True;0;0;0;False;0;False;0.372;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;179;-3548.823,491.574;Inherit;False;Property;_Waves__ScaleX;Waves__Scale  X;7;0;Create;True;0;0;0;False;0;False;0.368;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;85;-2483.979,-744.7645;Inherit;False;2090.815;1029.931;Foam;23;91;81;110;72;119;112;113;115;97;71;106;116;70;98;104;205;102;105;101;189;100;160;159;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;251;-1280,1134;Inherit;False;Property;_BigWaves__Scale;Big Waves__Scale;13;0;Create;True;0;0;0;False;0;False;0.2;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-2288,-384;Inherit;False;Property;_Foam__Border;Foam__Border;19;0;Create;True;0;0;0;False;0;False;0;0.412;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;416;-1888,-2592;Inherit;False;1476;608;Pattern Detail;11;386;399;400;406;387;414;404;405;385;407;411;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;400;-1840,-2416;Inherit;False;Property;_Water__PatternDetailSpeed;Water__Pattern Detail Speed;28;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;343;-1040,-1040;Inherit;False;471;209;Le resto el Depth que genera la camara;2;342;338;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;387;-1552,-2336;Inherit;False;Property;_Water__PatternScale;Water__Pattern Scale;27;0;Create;True;0;0;0;False;0;False;7.37;100;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;110;-992,-416;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;68;-1488,-1504;Inherit;False;66;WavesPattern;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.CameraDepthFade;338;-1008,-976;Inherit;False;3;2;FLOAT3;0,0,0;False;0;FLOAT;-22.2;False;1;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;82;-944,-1296;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;63;-1040,-1216;Inherit;False;Property;_Depth__Color;Depth__Color;17;0;Create;True;0;0;0;False;0;False;0.990566,0.1170263,0,0;0.4394352,0.745283,0.6508056,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;59;-1152,-1488;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;81;-800,-416;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;405;-1056,-2288;Inherit;True;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.ColorNode;57;-1248,-1712;Inherit;False;Property;_Waves__ColorSecondary;Waves__Color Secondary;6;0;Create;True;0;0;0;False;0;False;0.510235,0.8939884,0.9245283,0;0.1137253,0.1803919,0.4588232,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;56;-1248,-1904;Inherit;False;Property;_Waves__ColorPrimary;Waves__Color Primary;5;0;Create;True;0;0;0;False;0;False;0.510235,0.8939884,0.9245283,0;0.07782967,0.1202824,0.3113202,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;385;-1056,-2544;Inherit;True;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.RangedFloatNode;418;-160,-1312;Inherit;False;Property;_Water__DetailPatternFactor;Water__Detail Pattern Factor;29;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;88;-160,-160;Inherit;False;Property;_Water__OpacityFactor;Water__Opacity Factor;32;0;Create;True;0;0;0;False;0;False;0;0.9;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;308;-160,-80;Inherit;False;Property;_Foam__BorderBlend;Foam__Border Blend;23;0;Create;True;0;0;0;False;0;False;0;0.05;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;299;189.9106,-736.2684;Inherit;False;933.308;253.9423;Normal Construct;5;172;164;171;168;300;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;172;221.9106,-576.2685;Inherit;False;Property;_Waves__NormalFactor;Waves__Normal Factor;12;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;349;432,-80;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;193;288,608;Inherit;False;Property;_Water__VertexOffsetFactor;Water__Vertex Offset Factor;30;0;Create;True;0;0;0;False;0;False;0;0.0015;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;298;928,-1216;Inherit;False;CloudsPattern;-1;;20;bc2eb12446620194aa304028cc3322f4;0;1;21;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT;29
...
Node;AmplifyShaderEditor.FunctionNode;168;605.9103,-672.2685;Inherit;False;Normal From Height;-1;;19;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;1;False;2;FLOAT3;40;FLOAT3;0
Node;AmplifyShaderEditor.GrabScreenPosition;324;-3078.023,-1585.603;Inherit;False;0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;327;-2822.024,-1393.603;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;312;944,-304;Inherit;False;OpacityOutput;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;328;-3078.023,-1297.603;Inherit;False;Property;_Float0;Float 0;26;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;325;-2854.024,-1585.603;Inherit;False;True;True;True;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;170;1536,-384;Inherit;False;Property;_Water__Smoothness;Water__Smoothness;31;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;300;909.9105,-672.2685;Inherit;False;NormalOutput;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;329;-3078.023,-1393.603;Inherit;False;300;NormalOutput;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ScreenColorNode;330;-2369.34,-1371.173;Inherit;False;Global;_GrabScreen0;Grab Screen 0;26;0;Create;True;0;0;0;False;0;False;Object;-1;False;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;326;-2582.024,-1585.603;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.NegateNode;425;-2188.532,855.2251;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1920,-512;Float;False;True;-1;6;ASEMaterialInspector;0;0;Standard;Lemu/Nature/Water;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;True;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;0;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=A02496762FACBEB3A94C9E2C856097BEDB748060