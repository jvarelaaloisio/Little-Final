...
Shader "Lemu/Common/PineLeaves"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( float4( ( rotatedValue2_g17 - temp_output_14_0_g17 ) , 0.0 ) + lerpResult66 ).xyz;
			v.vertex.w = 1;
		}
...
/*ASEBEGIN
Version=18900
5;1068;1931;916;4128.939;584.0795;2.487542;True;False
...
Node;AmplifyShaderEditor.ColorNode;3;-1408,-32;Inherit;False;Property;_Color__Multiplier;Color__Multiplier;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.03524386,0.2264149,0.1701881,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=71BB4DC1FCCA22D04BBFD25AB754DF4A0F1FBDB3