...
Shader "StandarTreeURP"
{
	Properties
	{
		...
		_Shadow_Factor("Shadow_Factor", Range( 0 , 1)) = 0.09155273
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime22 = _Time.y * ( _Wind_BaseSpeed * 0.001 );
			float lerpResult28 = lerp( _Wind_PrimarySpeed , _Wind_SecondarySpeed , ( ( sin( mulTime22 ) + 1.0 ) * 0.5 ));
			...
			float simplePerlin2D47 = snoise( uv_TexCoord45*_Wind_NoiseAnimationScale );
			simplePerlin2D47 = simplePerlin2D47*0.5 + 0.5;
			float temp_output_62_0 = (0.0 + (( simplePerlin2D47 * 0.001 ) - 0.0) * (( _Wind_NoiseFactor * 0.001 ) - 0.0) / (1.0 - 0.0));
			...
			float MASK_IndividualRandomAnimationMask90 = saturate( (_Wind_WorldNoiseLevels.z + (simplePerlin2D11_g18 - _Wind_WorldNoiseLevels.x) * (_Wind_WorldNoiseLevels.w - _Wind_WorldNoiseLevels.z) / (_Wind_WorldNoiseLevels.y - _Wind_WorldNoiseLevels.x)) );
			...
			float temp_output_43_0 = pow( dotResult38 , _Light_MaskScale );
			o.vertexToFrag52 = temp_output_43_0;
			float dotResult37 = dot( ase_worldNormal , ase_worldlightDir );
			float temp_output_44_0 = pow( dotResult37 , _Shadow_MaskScale );
			o.vertexToFrag53 = temp_output_44_0;
		}

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float4 VAR_LeavesBaseColor79 = _Leaves_BaseColor;
			float4 VAR_LeavesLightColor80 = _Light_Color;
			...
			#endif //aselc
			float MASK_LightMask100 = ( saturate( ( temp_output_43_0 * ase_lightColor * i.vertexToFrag52 ) ) * _Light_Factor ).a;
			float4 lerpResult85 = lerp( VAR_LeavesBaseColor79 , VAR_LeavesLightColor80 , MASK_LightMask100);
			float4 VAR_LeavesShadowColor81 = _Shadow_Color;
			float dotResult37 = dot( ase_worldNormal , ase_worldlightDir );
			float temp_output_44_0 = pow( dotResult37 , _Shadow_MaskScale );
			float MASK_ShadowMask99 = ( ( 1.0 - saturate( ( temp_output_44_0 * ase_lightColor * i.vertexToFrag53 ) ) ) * _Shadow_Factor ).a;
...
Node;AmplifyShaderEditor.ColorNode;69;-3405.828,-1049.597;Inherit;False;Property;_Leaves_BaseColor;Leaves_BaseColor;1;0;Create;True;0;0;0;False;0;False;0.3019608,0.3019608,0.3019608,0;0.1019603,0.3019603,0.2431367,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;76;-3405.828,-873.5966;Inherit;False;Property;_Light_Color;Light_Color;3;0;Create;True;0;0;0;False;0;False;0.6,0.6,0.6,0;0.1999995,0.6,0.4823529,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;77;-3405.828,-697.5966;Inherit;False;Property;_Shadow_Color;Shadow_Color;6;0;Create;True;0;0;0;False;0;False;0.1921569,0.1921569,0.1921569,0;0.06274473,0.1921564,0.1568623,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;40;-4029.828,-187.5967;Inherit;False;Property;_Light_MaskScale;Light_Mask Scale;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;66;-3469.828,-169.5967;Inherit;False;Property;_Light_Factor;Light_Factor;4;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-4238.828,262.4033;Inherit;False;Property;_Shadow_MaskScale;Shadow_Mask Scale;8;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-3773.828,278.4033;Inherit;False;Property;_Shadow_Factor;Shadow_Factor;7;0;Create;True;0;0;0;False;0;False;0.09155273;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;116;-4254.828,949.4034;Inherit;False;Property;_Wind_Direction;Wind_Direction;10;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;-3933.828,1094.403;Inherit;False;Property;_Wind_WorldNoiseScale;Wind_World Noise Scale;16;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;57;-3453.828,1078.403;Inherit;False;Constant;_Wind_WorldNoiseLevels;Wind_World Noise Levels;18;0;Create;True;0;0;0;False;0;False;0.3,0.5,0,0.6;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-5837.273,670.5364;Inherit;False;Property;_Wind_BaseSpeed;Wind_Base Speed;11;0;Create;True;0;0;0;False;0;False;0;0.03;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-5187.273,506.5364;Inherit;False;Property;_Wind_PrimarySpeed;Wind_Primary Speed;12;0;Create;True;0;0;0;False;0;False;0.2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-5189.273,587.5364;Inherit;False;Property;_Wind_SecondarySpeed;Wind_Secondary Speed;13;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-3550.828,726.4034;Inherit;False;Property;_Wind_NoiseFactor;Wind_Noise Factor;14;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-3853.828,629.4034;Inherit;False;Property;_Wind_NoiseAnimationScale;Wind_Noise Animation Scale;15;0;Create;True;0;0;0;False;0;False;0.3;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;104;-381.8279,886.4034;Inherit;False;Property;_ProximityMask_Size;ProximityMask_Size;17;0;Create;True;0;0;0;False;0;False;0.15;0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-125.8279,1237.403;Inherit;False;Property;_ProximityMask_Factor;ProximityMask_Factor;20;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B22A02BC955505C67D49AA69CAFA6DE33BC1D175