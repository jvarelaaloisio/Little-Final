...
Shader "Lemu/Nature/StandardTree"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_21_0_g28 = ( saturate( ( VAR_LeavesLightColor297 * lerpResult10_g32 ) ) + lerpResult78 );
			...
			float2 panner10_g29 = ( 1.0 * _Time.y * temp_cast_1 + ( appendResult5_g28 * temp_output_2_0_g28 ));
			...
			float2 panner10_g31 = ( 1.0 * _Time.y * temp_cast_2 + ( appendResult5_g28 * 0.01 ));
			float simplePerlin2D11_g31 = snoise( panner10_g31 );
			simplePerlin2D11_g31 = simplePerlin2D11_g31*0.5 + 0.5;
			float2 temp_cast_3 = (0.1).xx;
			float2 panner10_g30 = ( 1.0 * _Time.y * temp_cast_3 + ( appendResult5_g28 * ( temp_output_2_0_g28 * 4.0 ) ));
			...
			float4 OUT_BaseColor21 = saturate( lerpResult24_g28 );
			...
			o.Emission = ( VAR_LeavesLightColor297 * saturate( ( fresnelNode410 * i.ASEIsFrontFacing ) ) ).rgb;
...
Node;AmplifyShaderEditor.CommentaryNode;308;-368,-640;Inherit;False;1604.7;585.1;;10;21;78;302;306;53;305;301;300;370;439;Light and shadow basecolor blend;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;45;-1232,-224;Inherit;False;Property;_Light_Color;Light_Color;3;0;Create;True;0;0;0;False;0;False;0.6,0.6,0.6,0;0.07450979,0.737255,0.6335085,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;3;-1232,-400;Inherit;False;Property;_Leaves_BaseColor;Leaves_BaseColor;1;0;Create;True;0;0;0;False;0;False;0.3019608,0.3019608,0.3019608,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;77;-1232,-48;Inherit;False;Property;_Shadow_Color;Shadow_Color;6;0;Create;True;0;0;0;False;0;False;0.1921569,0.1921569,0.1921569,0;0.04071416,0.01371701,0.319,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-2064,912;Inherit;False;Property;_Shadow_MaskScale;Shadow_Mask Scale;8;0;Create;True;0;0;0;False;0;False;0.3;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;322;1024,640;Inherit;False;19;OUT_Opacity;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;280;1024,544;Inherit;False;Property;_Smoothness;Smoothness;21;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;307;640,128;Inherit;False;21;OUT_BaseColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;407;864,128;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;413;384,256;Inherit;False;297;VAR_LeavesLightColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;412;800,256;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;417;384.0529,-503.8838;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;78;177,-407;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;302;-302,-310;Inherit;False;299;VAR_LeavesShadowColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;306;-302,-230;Inherit;False;304;MASK_ShadowMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;422;63.38037,-789.4408;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;423;212.3804,-772.4408;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;428;-382.5507,-970.4043;Inherit;False;2;2;0;INT;0;False;1;INT;0;False;1;INT;0
Node;AmplifyShaderEditor.FresnelNode;410;302,349;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;414;569,346;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;434;561.798,452.6618;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;268;1018,736;Inherit;False;239;OUT_VertexOffset;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FaceVariableNode;433;341.2377,542.4831;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;424;-601.6196,-804.4408;Inherit;False;Property;_ShowdSpots;ShowdSpots;22;0;Create;True;0;0;0;False;0;False;0;0.07;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexIdVariableNode;416;-676.2227,-960.7761;Inherit;False;0;1;INT;0
Node;AmplifyShaderEditor.InstanceIdNode;427;-672.5507,-1050.404;Inherit;False;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;418;-187.1213,-838.22;Inherit;False;Random Range;-1;;32;7b754edb8aebbfb4a9ace907af661cfc;0;3;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;21;974.5001,-420.7;Inherit;False;OUT_BaseColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;370;536.6998,-472.9997;Inherit;False;CloudsPattern;-1;;28;bc2eb12446620194aa304028cc3322f4;0;1;21;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT;29
Node;AmplifyShaderEditor.SaturateNode;439;823.8551,-472.9535;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=B0CB9587B6224BC7E973FD5C6F0C42025023FA64