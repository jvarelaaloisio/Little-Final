	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float dotResult33 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float temp_output_34_0 = pow( dotResult33 , _Light__MaskScale );
				float vertexToFrag41 = temp_output_34_0;
				o.ase_texcoord8.x = vertexToFrag41;
				float dotResult63 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float temp_output_64_0 = pow( dotResult63 , _Shadow__MaskScale );
				float vertexToFrag66 = temp_output_64_0;
				o.ase_texcoord8.y = vertexToFrag66;
						 ...
						 ) : SV_Target
			{
				...
				float4 VAR_LeavesBaseColor298 = _Leaves__BaseColor;
				float4 VAR_LeavesLightColor297 = _Light__Color;
				float dotResult33 = dot( WorldNormal , _MainLightPosition.xyz );
				float temp_output_34_0 = pow( dotResult33 , _Light__MaskScale );
				float vertexToFrag41 = IN.ase_texcoord8.x;
				float MASK_LightMask303 = ( saturate( ( temp_output_34_0 * _MainLightColor * vertexToFrag41 ) ) * _Light__Factor ).a;
				float4 lerpResult53 = lerp( VAR_LeavesBaseColor298 , VAR_LeavesLightColor297 , MASK_LightMask303);
				float4 VAR_LeavesShadowColor299 = _Shadow__Color;
				float dotResult63 = dot( WorldNormal , _MainLightPosition.xyz );
				float temp_output_64_0 = pow( dotResult63 , _Shadow__MaskScale );
				float vertexToFrag66 = IN.ase_texcoord8.y;
				float MASK_ShadowMask304 = ( ( 1.0 - saturate( ( temp_output_64_0 * _MainLightColor * vertexToFrag66 ) ) ) * _Shadow__Factor ).a;
				...
				float2 uv_Leaves_AlphaLeaf138 = IN.ase_texcoord8.zw;
				float OUT_Opacity19 = tex2D( _Leaves_AlphaLeaf, uv_Leaves_AlphaLeaf138 ).a;
				

				float3 BaseColor = saturate( OUT_BaseColor21 ).rgb;
				...
				float Occlusion = 1;
				float Alpha = OUT_Opacity19;
				float AlphaClipThreshold = ( 1.0 - OUT_Opacity19 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Leaves_AlphaLeaf138 = IN.ase_texcoord2.xy;
				float OUT_Opacity19 = tex2D( _Leaves_AlphaLeaf, uv_Leaves_AlphaLeaf138 ).a;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_34_0 = pow( dotResult33 , _Light__MaskScale );
				float vertexToFrag41 = temp_output_34_0;
				o.ase_texcoord4.w = vertexToFrag41;
				float dotResult63 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float temp_output_64_0 = pow( dotResult63 , _Shadow__MaskScale );
				float vertexToFrag66 = temp_output_64_0;
				o.ase_texcoord5.x = vertexToFrag66;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float dotResult33 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float temp_output_34_0 = pow( dotResult33 , _Light__MaskScale );
				float vertexToFrag41 = IN.ase_texcoord4.w;
				float MASK_LightMask303 = ( saturate( ( temp_output_34_0 * _MainLightColor * vertexToFrag41 ) ) * _Light__Factor ).a;
				float4 lerpResult53 = lerp( VAR_LeavesBaseColor298 , VAR_LeavesLightColor297 , MASK_LightMask303);
				float4 VAR_LeavesShadowColor299 = _Shadow__Color;
				float dotResult63 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float temp_output_64_0 = pow( dotResult63 , _Shadow__MaskScale );
				float vertexToFrag66 = IN.ase_texcoord5.x;
				float MASK_ShadowMask304 = ( ( 1.0 - saturate( ( temp_output_64_0 * _MainLightColor * vertexToFrag66 ) ) ) * _Shadow__Factor ).a;
				float4 lerpResult78 = lerp( lerpResult53 , VAR_LeavesShadowColor299 , MASK_ShadowMask304);
				float4 temp_output_21_0_g28 = lerpResult78;
				float4 color20_g28 = IsGammaSpace() ? float4(0.509434,0.509434,0.509434,0) : float4(0.2228772,0.2228772,0.2228772,0);
				...
				float2 uv_Leaves_AlphaLeaf138 = IN.ase_texcoord5.yz;
				float OUT_Opacity19 = tex2D( _Leaves_AlphaLeaf, uv_Leaves_AlphaLeaf138 ).a;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_34_0 = pow( dotResult33 , _Light__MaskScale );
				float vertexToFrag41 = temp_output_34_0;
				o.ase_texcoord2.w = vertexToFrag41;
				float dotResult63 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float temp_output_64_0 = pow( dotResult63 , _Shadow__MaskScale );
				float vertexToFrag66 = temp_output_64_0;
				o.ase_texcoord3.x = vertexToFrag66;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float dotResult33 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float temp_output_34_0 = pow( dotResult33 , _Light__MaskScale );
				float vertexToFrag41 = IN.ase_texcoord2.w;
				float MASK_LightMask303 = ( saturate( ( temp_output_34_0 * _MainLightColor * vertexToFrag41 ) ) * _Light__Factor ).a;
				float4 lerpResult53 = lerp( VAR_LeavesBaseColor298 , VAR_LeavesLightColor297 , MASK_LightMask303);
				float4 VAR_LeavesShadowColor299 = _Shadow__Color;
				float dotResult63 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float temp_output_64_0 = pow( dotResult63 , _Shadow__MaskScale );
				float vertexToFrag66 = IN.ase_texcoord3.x;
				float MASK_ShadowMask304 = ( ( 1.0 - saturate( ( temp_output_64_0 * _MainLightColor * vertexToFrag66 ) ) ) * _Shadow__Factor ).a;
				float4 lerpResult78 = lerp( lerpResult53 , VAR_LeavesShadowColor299 , MASK_ShadowMask304);
				float4 temp_output_21_0_g28 = lerpResult78;
				float4 color20_g28 = IsGammaSpace() ? float4(0.509434,0.509434,0.509434,0) : float4(0.2228772,0.2228772,0.2228772,0);
				...
				float2 uv_Leaves_AlphaLeaf138 = IN.ase_texcoord3.yz;
				float OUT_Opacity19 = tex2D( _Leaves_AlphaLeaf, uv_Leaves_AlphaLeaf138 ).a;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_Leaves_AlphaLeaf138 = IN.ase_texcoord4.xy;
				float OUT_Opacity19 = tex2D( _Leaves_AlphaLeaf, uv_Leaves_AlphaLeaf138 ).a;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Leaves_AlphaLeaf138 = IN.ase_texcoord.xy;
				float OUT_Opacity19 = tex2D( _Leaves_AlphaLeaf, uv_Leaves_AlphaLeaf138 ).a;
				

				surfaceDescription.Alpha = OUT_Opacity19;
				surfaceDescription.AlphaClipThreshold = ( 1.0 - OUT_Opacity19 );
...
Node;AmplifyShaderEditor.RangedFloatNode;215;-3663.445,1320.133;Inherit;False;Property;_Wind__BaseSpeed;Wind__Base Speed;10;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;164;-3013.445,1157.133;Inherit;False;Property;_Wind__PrimarySpeed;Wind__Primary Speed;11;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;237;-3013.445,1237.133;Inherit;False;Property;_Wind__SecondarySpeed;Wind__Secondary Speed;12;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;144;-1680,1280;Inherit;False;Property;_Wind__NoiseAnimationScale;Wind__Noise Animation Scale;14;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;165;-1376,1376;Inherit;False;Property;_Wind__NoiseFactor;Wind__Noise Factor;13;0;Create;True;0;0;0;False;0;False;2;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;3;-1232,-400;Inherit;False;Property;_Leaves__BaseColor;Leaves__BaseColor;0;0;Create;True;0;0;0;False;0;False;0.3019608,0.3019608,0.3019608,0;0.1268244,0.4716981,0.216122,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;45;-1232,-224;Inherit;False;Property;_Light__Color;Light__Color;2;0;Create;True;0;0;0;False;0;False;0.6,0.6,0.6,0;0.2469739,0.6981132,0.5019658,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;77;-1232,-48;Inherit;False;Property;_Shadow__Color;Shadow__Color;5;0;Create;True;0;0;0;False;0;False;0.1921569,0.1921569,0.1921569,0;0.207843,0.2431371,0.07843123,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;296;400,1776;Inherit;False;Property;_LocalVertexOffsetFactor;LocalVertexOffsetFactor;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;291;1792,1888;Inherit;False;Property;_ProximityMask_SizeMax;ProximityMask_SizeMax;18;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;286;1792,1536;Inherit;False;Property;_ProximityMask__Size;ProximityMask__Size;16;0;Create;True;0;0;0;False;0;False;0.15;0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;287;1792,1808;Inherit;False;Property;_ProximityMask_SizeMin;ProximityMask_SizeMin;17;0;Create;True;0;0;0;False;0;False;-0.2;-0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;292;2048,1888;Inherit;False;Property;_ProximityMask__Factor;ProximityMask__Factor;19;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;327;-2080,1600;Inherit;False;Property;_Wind__Direction;Wind__Direction;9;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;393;1461.947,385.4701;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;395;1461.947,385.4701;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;396;1461.947,385.4701;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;397;1461.947,385.4701;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;398;1461.947,385.4701;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;399;1461.947,385.4701;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;400;1461.947,385.4701;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;401;1461.947,385.4701;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;402;1461.947,385.4701;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;394;1536,384;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Lemu/Nature/StandardTree;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;True;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;638203923777093732;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;638203929570597368;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;280;960,480;Inherit;False;Property;_Smoothness;Smoothness;20;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;322;960,576;Inherit;False;19;OUT_Opacity;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;403;1200,576;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;408;1170,550;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;394;0;407;0
WireConnection;394;4;280;0
WireConnection;394;6;408;0
WireConnection;394;7;403;0
WireConnection;403;0;322;0
WireConnection;407;0;307;0
WireConnection;408;0;322;0
ASEEND*/
//CHKSM=3C3B4B903C0C5535B1E07B86B3015EE15008EB44