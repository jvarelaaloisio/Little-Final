...
Shader "SpacialSkybox"
{
	Properties
	{
		_Space__Color("Space__Color", Color) = (0,0.007317648,0.02,0)
		[NoScaleOffset]_Space__Pattern("Space__Pattern", 2D) = "white" {}
		_Space__Scale("Space__Scale", Float) = 0
		_Starts__Scale("Starts__Scale", Float) = 0
		_Stars__FactorSmall("Stars__Factor Small", Float) = 0.01
		_Start__FactprBig("Start__Factpr Big", Float) = 0
		_BigStarts__MaskFactor("BigStarts__Mask Factor", Float) = 0
		_Starts__AnimationSpeed("Starts__Animation Speed", Float) = 0
	...
	SubShader
	{
		...
		uniform float4 _Space__Color;
		uniform float _Space__Scale;
		uniform sampler2D _Space__Pattern;
		uniform float _Starts__Scale;
		uniform float _Stars__FactorSmall;
		uniform float _Starts__AnimationSpeed;
		uniform float _Start__FactprBig;
		uniform float _BigStarts__MaskFactor;
		...
		{
			float VAR_BackgroundScale44 = _Space__Scale;
			float simplePerlin2D15 = snoise( i.viewDir.xy*VAR_BackgroundScale44 );
			simplePerlin2D15 = simplePerlin2D15*0.5 + 0.5;
			float4 tex2DNode17 = tex2D( _Space__Pattern, ( VAR_BackgroundScale44 * i.viewDir ).xy );
			float4 VAR_SpcaeBackground62 = ( _Space__Color * ( simplePerlin2D15 * tex2DNode17.r ) );
			float simplePerlin2D23 = snoise( i.viewDir.xy*_Starts__Scale );
			simplePerlin2D23 = simplePerlin2D23*0.5 + 0.5;
			float VAR_StarsSmall50 = step( simplePerlin2D23 , _Stars__FactorSmall );
			float mulTime69 = _Time.y * _Starts__AnimationSpeed;
			...
			float lerpResult34 = lerp( 0.0 , step( simplePerlin2D23 , (0.1 + (VAR_AnimationSteps76 - 0.0) * (_Start__FactprBig - 0.1) / (1.0 - 0.0)) ) , saturate( (_BigStarts__MaskFactor + (VAR_SpacePattern47 - 0.0) * (1.0 - _BigStarts__MaskFactor) / (1.0 - 0.0)) ));
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-2304,368;Inherit;False;Property;_Starts__Scale;Starts__Scale;3;0;Create;True;0;0;0;False;0;False;0;200;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-2080,368;Inherit;False;Property;_Start__FactprBig;Start__Factpr Big;5;0;Create;True;0;0;0;False;0;False;0;0.11;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-1424,368;Inherit;False;Property;_BigStarts__MaskFactor;BigStarts__Mask Factor;6;0;Create;True;0;0;0;False;0;False;0;-2.12;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-1792,272;Inherit;False;Property;_Stars__FactorSmall;Stars__Factor Small;4;0;Create;True;0;0;0;False;0;False;0.01;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-2304,672;Inherit;False;Property;_Starts__AnimationSpeed;Starts__Animation Speed;7;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;128,-512;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;SpacialSkybox;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
Node;AmplifyShaderEditor.ColorNode;20;-2032,-560;Inherit;False;Property;_Space__Color;Space__Color;0;0;Create;True;0;0;0;False;0;False;0,0.007317648,0.02,0;0,0.007317648,0.02,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;17;-1792,-160;Inherit;True;Property;_Space__Pattern;Space__Pattern;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;1783185b5929520498b373a2f612eee4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;46;-2304,-160;Inherit;False;44;VAR_BackgroundScale;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1504,-960;Inherit;False;Property;_Space__Scale;Space__Scale;2;0;Create;True;0;0;0;False;0;False;0;4.63;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=9A76651347138B77208625F4D91D884FF01C2626