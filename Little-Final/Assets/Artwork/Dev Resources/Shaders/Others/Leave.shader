...
Shader "Drimys/Nature/TEST/Leave"
{
	Properties
	{
		...
		[ASEBegin][NoScaleOffset]_BaseColor1("Base Color", 2D) = "white" {}
		...
		[ASEEnd]_LocalWindMask1("Local Wind Mask", Range( -1 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _LocalWindMask1;
			float _BaseColorHue1;
			float _BaseColorSaturation1;
			float _BaseColorValue1;
			...
			float WindSpeed1;
			float WindTurbulence1;
			float WindIntensity1;
			float WindDirX1;
			float WindDirZ1;
			float WindMaskGlobal1;
			float WindSpeedGlobal1;
			float WindIntensityGlobal1;
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime959 = _TimeParameters.x * WindSpeed1;
				float4 appendResult961 = (float4(mulTime959 , 0.0 , 0.0 , 0.0));
				float2 texCoord965 = v.texcoord.xy * float2( 1,1 ) + appendResult961.xy;
				float simplePerlin2D968 = snoise( texCoord965*(0.5 + (WindTurbulence1 - 0.0) * (0.7 - 0.5) / (1.0 - 0.0)) );
				...
				float4 transform993 = mul(GetWorldToObjectMatrix(),float4( ( appendResult985 * (0.0 + (v.ase_color.r - 0.0) * (_LocalWindMask1 - 0.0) / (1.0 - 0.0)) ) , 0.0 ));
				...
				float4 OUT_VertexOffset1010 = lerpResult1001;
				...
				float3 vertexValue = OUT_VertexOffset1010.xyz;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_BaseColor1977 = IN.ase_texcoord8.xy;
				...
				float3 OUT_BaseColor1007 = saturate( hsvTorgb994 );
				
				float OUT_Opacity1008 = tex2DNode977.a;
				

				float3 BaseColor = OUT_BaseColor1007;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float mulTime959 = _TimeParameters.x * WindSpeed1;
				float4 appendResult961 = (float4(mulTime959 , 0.0 , 0.0 , 0.0));
				float2 texCoord965 = v.ase_texcoord.xy * float2( 1,1 ) + appendResult961.xy;
				float simplePerlin2D968 = snoise( texCoord965*(0.5 + (WindTurbulence1 - 0.0) * (0.7 - 0.5) / (1.0 - 0.0)) );
				simplePerlin2D968 = simplePerlin2D968*0.5 + 0.5;
				float temp_output_971_0 = (0.0 + (simplePerlin2D968 - 0.0) * (WindIntensity1 - 0.0) / (1.0 - 0.0));
				float3 appendResult966 = (float3(WindDirX1 , ( ( ( abs( WindDirX1 ) + abs( WindDirZ1 ) ) / 4.0 ) * -1.0 ) , WindDirZ1));
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_BaseColor1977 = IN.ase_texcoord2.xy;
				float4 tex2DNode977 = tex2D( _BaseColor1, uv_BaseColor1977 );
				float OUT_Opacity1008 = tex2DNode977.a;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime959 = _TimeParameters.x * WindSpeed1;
				float4 appendResult961 = (float4(mulTime959 , 0.0 , 0.0 , 0.0));
				float2 texCoord965 = v.texcoord0.xy * float2( 1,1 ) + appendResult961.xy;
				float simplePerlin2D968 = snoise( texCoord965*(0.5 + (WindTurbulence1 - 0.0) * (0.7 - 0.5) / (1.0 - 0.0)) );
				simplePerlin2D968 = simplePerlin2D968*0.5 + 0.5;
				float temp_output_971_0 = (0.0 + (simplePerlin2D968 - 0.0) * (WindIntensity1 - 0.0) / (1.0 - 0.0));
				float3 appendResult966 = (float3(WindDirX1 , ( ( ( abs( WindDirX1 ) + abs( WindDirZ1 ) ) / 4.0 ) * -1.0 ) , WindDirZ1));
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_BaseColor1977 = IN.ase_texcoord4.xy;
				float4 tex2DNode977 = tex2D( _BaseColor1, uv_BaseColor1977 );
				float3 hsvTorgb980 = RGBToHSV( tex2DNode977.rgb );
				float3 hsvTorgb994 = HSVToRGB( float3(( hsvTorgb980.x + _BaseColorHue1 ),( hsvTorgb980.y + _BaseColorSaturation1 ),( hsvTorgb980.z + _BaseColorValue1 )) );
				float3 OUT_BaseColor1007 = saturate( hsvTorgb994 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_BaseColor1977 = IN.ase_texcoord.xy;
				float4 tex2DNode977 = tex2D( _BaseColor1, uv_BaseColor1977 );
				float OUT_Opacity1008 = tex2DNode977.a;
				

				surfaceDescription.Alpha = OUT_Opacity1008;
...
Node;AmplifyShaderEditor.RangedFloatNode;952;1387.624,1845.449;Inherit;False;Global;WindDirX1;Wind Dir X;3;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;953;1380.006,1979.758;Inherit;False;Global;WindDirZ1;Wind Dir Z;4;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;956;968.7573,1395.961;Inherit;False;Global;WindSpeed1;Wind Speed;6;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;962;971.2415,1506.265;Inherit;False;Global;WindTurbulence1;Wind Turbulence;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;967;1710.574,1479.363;Inherit;False;Global;WindIntensity1;Wind Intensity;5;0;Create;True;0;0;0;False;0;False;0.2;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;972;2616.535,1731.001;Inherit;False;Property;_LocalWindMask1;Local Wind Mask;7;0;Create;True;0;0;0;False;0;False;0;1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;984;2986.611,1915.832;Inherit;False;Global;WindSpeedGlobal1;Wind Speed (Global);1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;986;3253.454,917.2249;Inherit;False;Property;_BaseColorValue1;Base Color Value;4;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;978;2986.611,1991.832;Inherit;False;Global;WindIntensityGlobal1;Wind Intensity(Global);2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;983;3253.57,847.6741;Inherit;False;Property;_BaseColorSaturation1;Base Color Saturation;3;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;982;3252.953,776.8793;Inherit;False;Property;_BaseColorHue1;Base Color Hue;2;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;990;3385.61,2007.83;Inherit;False;WorldNoise;-1;;1;f17c4c9c155f92e4cb0e3f353a46552a;0;3;14;FLOAT2;0,0;False;13;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;987;3375.46,1915.232;Inherit;False;Global;WindMaskGlobal1;Wind Mask (Global);0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1004;3201.381,31.16868;Inherit;True;Global;_CameraGBufferTexture1;_CameraGBufferTexture0;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;998;3245.965,-102.0737;Inherit;False;Property;_GroundBlend1;GroundBlend;5;0;Create;True;0;0;0;False;0;False;0;4.82;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1008;2878.968,941.3495;Inherit;False;OUT_Opacity;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1011;4713.688,1054.534;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1013;4713.688,1054.534;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1014;4713.688,1054.534;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1015;4713.688,1054.534;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1016;4713.688,1054.534;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1017;4713.688,1054.534;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1018;4713.688,1054.534;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1019;4713.688,1054.534;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1020;4713.688,1054.534;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1010;4447.42,1344.269;Inherit;False;OUT_VertexOffset;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;1009;4448.166,1185.158;Inherit;False;1008;OUT_Opacity;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1007;4449.927,1024.771;Inherit;False;OUT_BaseColor;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1012;4737.688,1057.534;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Drimys/Nature/TEST/Leave;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;1008;0;977;4
WireConnection;1010;0;1001;0
WireConnection;1007;0;1006;0
WireConnection;1012;0;1007;0
WireConnection;1012;6;1009;0
WireConnection;1012;8;1010;0
ASEEND*/
//CHKSM=5C5AA4CD8B69F506D4177F497C991F91FEEE5E53