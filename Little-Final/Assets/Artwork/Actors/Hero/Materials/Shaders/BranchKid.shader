...
Shader "BranchKid"
{
	Properties
	{
		[NoScaleOffset]_PBR__BaseColor("PBR__BaseColor", 2D) = "white" {}
		[NoScaleOffset][Normal]_PBR__Normal("PBR__Normal", 2D) = "bump" {}
		[NoScaleOffset]_PBR__Emissive("PBR__Emissive", 2D) = "white" {}
		_Magic__ActiveValue("Magic__ActiveValue", Range( 0 , 1)) = 1
		[NoScaleOffset]_Magic__Mask("Magic__Mask", 2D) = "white" {}
		_Magic__ActiveColor("Magic__ActiveColor", Color) = (0,1,0.8446779,0)
		_Magic__InactiveColor("Magic__InactiveColor", Color) = (0,1,0.8446779,0)
		[NoScaleOffset][Normal]_Magic__Distortion("Magic__Distortion", 2D) = "bump" {}
		_Distortion__Factor("Distortion__Factor", Float) = 1
		_Distortion___Speed("Distortion___Speed", Float) = 0.0001
		_Distortion__Scale("Distortion__Scale", Float) = 1
		_Sparks__Color("Sparks__Color", Color) = (1,0,0.9479666,0)
		_Sparks__Speed("Sparks__Speed", Float) = 1
		_Sparks__Scale("Sparks__Scale", Float) = 2
	...
	SubShader
	{
		...
		uniform sampler2D _PBR__Normal;
		uniform sampler2D _PBR__BaseColor;
		uniform sampler2D _PBR__Emissive;
		uniform float4 _Magic__InactiveColor;
		uniform sampler2D _Magic__Mask;
		uniform sampler2D _Magic__Distortion;
		uniform float _Distortion___Speed;
		uniform float _Distortion__Scale;
		uniform float _Distortion__Factor;
		uniform float _Magic__ActiveValue;
		uniform float _Sparks__Speed;
		uniform float _Sparks__Scale;
		uniform float4 _Magic__ActiveColor;
		uniform float4 _Sparks__Color;
		...
		{
			float2 uv_PBR__Normal6 = i.uv_texcoord;
			float3 OUT_NormalMap87 = UnpackNormal( tex2D( _PBR__Normal, uv_PBR__Normal6 ) );
			o.Normal = OUT_NormalMap87;
			float2 uv_PBR__BaseColor1 = i.uv_texcoord;
			float4 temp_output_21_0_g10 = tex2D( _PBR__BaseColor, uv_PBR__BaseColor1 );
			...
			float2 uv_PBR__Emissive9 = i.uv_texcoord;
			float2 appendResult184 = (float2(0.0 , _Distortion___Speed));
			float2 appendResult152 = (float2(ase_worldPos.x , ase_worldPos.y));
			float2 UV_GlobalCordinates154 = appendResult152;
			float2 panner183 = ( 1.0 * _Time.y * appendResult184 + ( UV_GlobalCordinates154 * _Distortion__Scale ));
			float Activate72 = _Magic__ActiveValue;
			float Magic__Mask61 = tex2D( _Magic__Mask, ( float3( i.uv_texcoord ,  0.0 ) + UnpackScaleNormal( tex2D( _Magic__Distortion, panner183 ), ( _Distortion__Factor * Activate72 ) ) ).xy ).r;
			float2 appendResult136 = (float2(0.0 , -_Sparks__Speed));
			float2 panner138 = ( 1.0 * _Time.y * appendResult136 + UV_GlobalCordinates154);
			float simplePerlin2D98 = snoise( panner138*_Sparks__Scale );
			simplePerlin2D98 = simplePerlin2D98*0.5 + 0.5;
			float2 appendResult145 = (float2(0.0 , -( _Sparks__Speed * 0.5 )));
			float2 panner142 = ( 1.0 * _Time.y * appendResult145 + UV_GlobalCordinates154);
			float simplePerlin2D141 = snoise( panner142*2.0 );
			simplePerlin2D141 = simplePerlin2D141*0.5 + 0.5;
			float MASK_Sparks160 = saturate( ( (-50.0 + (simplePerlin2D98 - 0.0) * (10.0 - -50.0) / (1.0 - 0.0)) * simplePerlin2D141 ) );
			float4 lerpResult41 = lerp( ( _Magic__InactiveColor * Magic__Mask61 ) , saturate( ( ( saturate( ( Magic__Mask61 - MASK_Sparks160 ) ) * _Magic__ActiveColor ) + ( _Sparks__Color * ( MASK_Sparks160 * Magic__Mask61 ) ) ) ) , Activate72);
			float4 COLOR_MagicEfffect92 = lerpResult41;
			float4 OUT_Emissive94 = ( tex2D( _PBR__Emissive, uv_PBR__Emissive9 ) + COLOR_MagicEfffect92 );
...
Node;AmplifyShaderEditor.CommentaryNode;161;-6656,624;Inherit;False;1922;565;;18;155;138;136;140;156;98;100;142;141;145;146;158;137;144;101;148;117;160;Sparks Animation Mask;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;156;-6272,928;Inherit;False;154;UV_GlobalCordinates;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;98;-5760,672;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;142;-5984,928;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;141;-5760,928;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;145;-6176,1008;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NegateNode;146;-6304,1008;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;158;-6432,1008;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;148;-5216,912;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;117;-5088,912;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;160;-4960,912;Inherit;False;MASK_Sparks;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;100;-5984,800;Inherit;False;Property;_Sparks__Scale;Sparks__Scale;13;0;Create;True;0;0;0;False;0;False;2;100;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;101;-5504,672;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-50;False;4;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;144;-5984,1056;Inherit;False;Constant;_BigNoiseScale;BigNoise Scale;9;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;137;-6608,832;Inherit;False;Property;_Sparks__Speed;Sparks__Speed;12;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;162;-6608,176;Inherit;False;Property;_Sparks__Color;Sparks__Color;11;0;Create;True;0;0;0;False;0;False;1,0,0.9479666,0;1,0.6776525,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-6608,-1280;Inherit;False;Property;_Magic__ActiveValue;Magic__ActiveValue;3;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;178;-5904,-720;Inherit;True;Property;_Magic__Distortion;Magic__Distortion;7;2;[NoScaleOffset];[Normal];Create;True;0;0;0;False;0;False;-1;None;ccd44a7950132444fb0dc8b9102739e0;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;188;-6608,-880;Inherit;False;Property;_Distortion__Scale;Distortion__Scale;10;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;185;-6608,-784;Inherit;False;Property;_Distortion___Speed;Distortion___Speed;9;0;Create;True;0;0;0;False;0;False;0.0001;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;179;-6400,-656;Inherit;False;Property;_Distortion__Factor;Distortion__Factor;8;0;Create;True;0;0;0;False;0;False;1;0.005;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;90;-6592,-352;Inherit;False;Property;_Magic__InactiveColor;Magic__InactiveColor;6;0;Create;True;0;0;0;False;0;False;0,1,0.8446779,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;34;-6608,0;Inherit;False;Property;_Magic__ActiveColor;Magic__ActiveColor;5;0;Create;True;0;0;0;False;0;False;0,1,0.8446779,0;0.9963673,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;95;-3072,-64;Inherit;False;94;OUT_Emissive;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;89;-3072,-160;Inherit;False;87;OUT_NormalMap;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-2752,-176;Float;False;True;-1;6;ASEMaterialInspector;0;0;Standard;BranchKid;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;0;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=11000ED7308ABB2A4F42BE68E6E744F168AB6596