...
Shader "M_SpeedLines"
{
	Properties
	{
		...
		_FramesPerSecond("Frames Per Second", Range( 0 , 120)) = 12
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag (ASEVaryingsDefault i  ) : SV_Target
			{
				...
				float temp_output_1_0_g3 = _CenterMaskSize;
				float temp_output_18_0 = ( 1.0 - ( ( ( distance( VertexTexCord55 , Center56 ) - temp_output_1_0_g3 ) / ( ( _CenterMaskSize + _CenterMaskEdge ) - temp_output_1_0_g3 ) ) * _LineDensity ) );
				float2 CenteredUV15_g2 = ( VertexTexCord55 - Center56 );
				float2 break17_g2 = CenteredUV15_g2;
				float2 appendResult23_g2 = (float2(( length( CenteredUV15_g2 ) * 0.07 * 2.0 ) , ( atan2( break17_g2.x , break17_g2.y ) * ( 1.0 / 6.28318548202515 ) * _LineQty )));
				float mulTime30 = _Time.y * _Speed;
				float FPS52 = ( floor( ( frac( mulTime30 ) * _FramesPerSecond ) ) * ( 1.0 / _FramesPerSecond ) * 6.28318548202515 );
				float cos29 = cos( FPS52 );
				float sin29 = sin( FPS52 );
				float2 rotator29 = mul( appendResult23_g2 - float2( 0,0 ) , float2x2( cos29 , -sin29 , sin29 , cos29 )) + float2( 0,0 );
...
Node;AmplifyShaderEditor.CommentaryNode;51;-586.6538,-1399.259;Inherit;False;1046.62;327.828;Output;5;33;32;50;36;5;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;5;289.6194,-1335.259;Float;False;True;-1;2;ASEMaterialInspector;0;8;M_SpeedLines;32139be9c1eb75640a847f011acf3bcf;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;True;7;False;;False;False;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;0;;0;0;Standard;0;0;1;True;False;;False;0
Node;AmplifyShaderEditor.FunctionNode;36;65.61915,-1335.259;Inherit;True;Lerp White To;-1;;5;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;50;-142.3813,-1271.258;Inherit;False;49;InvertedMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4;-1329.575,-936.9861;Inherit;False;Polar Coordinates;-1;;2;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;0.07;False;4;FLOAT;0.98;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;32;-430.3822,-1335.259;Inherit;True;Property;_TextureSample0;Texture Sample 0;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;33;-574.3824,-1319.259;Inherit;False;0;0;_MainTex;Shader;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-1648,-1216;Half;False;Property;_FramesPerSecond;Frames Per Second;7;0;Create;True;0;0;0;False;0;False;12;24;0;120;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;12;-1184,-464;Inherit;True;Inverse Lerp;-1;;3;09cbe79402f023141a4dc1fddd4c9511;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=80AF50EDABFA380BF940F9588E1F60875A707DD1