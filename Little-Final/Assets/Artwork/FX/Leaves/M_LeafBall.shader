...
Shader "M_LeafBall"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float cos21 = cos( ( -1.0 * mulTime10 ) );
			float sin21 = sin( ( -1.0 * mulTime10 ) );
			float2 rotator21 = mul( uv_TexCoord3 - float2( 0.5,0.5 ) , float2x2( cos21 , -sin21 , sin21 , cos21 )) + float2( 0.5,0.5 );
...
Node;AmplifyShaderEditor.ColorNode;7;-933.8773,222.8253;Inherit;False;Property;_Color;Color;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.6792453,0.3920449,0.1057314,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;3;-1588.615,43.85031;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-1641.404,-109.6876;Inherit;False;2;2;0;FLOAT;-1;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1001.804,-253.9875;Inherit;False;Property;_NoiseStep;Noise Step;4;0;Create;True;0;0;0;False;0;False;0;0.47;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=68C6D920A1889B7B15E1E6D9798167DFBCE19E08